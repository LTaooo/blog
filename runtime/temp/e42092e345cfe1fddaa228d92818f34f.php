<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpStudy\WWW\TP\tp5\public/../application/admin\view\article\lst.html";i:1528114292;s:61:"D:\phpStudy\WWW\TP\tp5\application\admin\view\common\top.html";i:1527605408;s:62:"D:\phpStudy\WWW\TP\tp5\application\admin\view\common\left.html";i:1527696574;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon"
 onclick="javascript:window.location.href ='<?php echo url('article/add'); ?>' "> <i class="fa fa-plus"></i> Add
</button>
<div class="row">  
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            <td align="center"><?php echo $article['cate']; ?></td>
                            <td align="center">
                            ...
                            <td align="center">
                                <img src="<?php echo SITE_URL.'/'.$article['pic']; ?>" alt="无法显示" height="30" width="30">
                            </td>

                            <td align="center">
                                <a href="<?php echo url('article/edit',array('id'=>$article['id'])); ?>"
                                class="btn btn-primary btn-sm shiny">
                                    <i class="fa fa-edit"></i> 编辑
                                </a>
                                <a href="#" onClick="warning('确实要删除吗', '<?php echo url('article/delete',array('id'=>$article['id'])); ?>')" 
