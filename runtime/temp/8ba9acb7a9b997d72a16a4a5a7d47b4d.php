<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"D:\phpStudy\WWW\TP\tp5\public/../application/admin\view\admin\lst.html";i:1527605095;s:61:"D:\phpStudy\WWW\TP\tp5\application\admin\view\common\top.html";i:1527605408;s:62:"D:\phpStudy\WWW\TP\tp5\application\admin\view\common\left.html";i:1527696574;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="center">
                                    <a href="<?php echo url('admin/edit',array('id'=>$user['id'])); ?>"
                                    class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('admin/del',array('id'=>$user['id'])); ?>')" 
