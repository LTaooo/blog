<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:69:"D:\phpStudy\WWW\TP\tp5\public/../application/admin\view\cate\add.html";i:1527695427;s:61:"D:\phpStudy\WWW\TP\tp5\application\admin\view\common\top.html";i:1527605408;s:62:"D:\phpStudy\WWW\TP\tp5\application\admin\view\common\left.html";i:1527696574;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs"> 
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('admin/lst'); ?>">管理栏目</a>
                    </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="cate" placeholder="" name="cate" required="" type="text">
                            </div>
